...
namespace Magezon\Composer\Ui\Component\Listing\Columns\CustomerPackages;
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item[$urlEntityParamName])) {
                    $viewUrlPath = $this->getData('config/viewUrlPath') ?: 'composer/customerpackages/edit';
                    $deleteUrlPath = 'composer/customerpackages/delete';
