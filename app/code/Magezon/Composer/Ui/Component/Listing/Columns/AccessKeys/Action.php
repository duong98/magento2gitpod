        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item[$urlEntityParamName])) {
                    $viewUrlPath = $this->getData('config/viewUrlPath') ?: 'composer/accesskeys/edit';
                    $deleteUrlPath = 'composer/accesskeys/delete';
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you want to delete the key %1 ?',$item['name']),
                            ],
                        ],
                    ];
                }
