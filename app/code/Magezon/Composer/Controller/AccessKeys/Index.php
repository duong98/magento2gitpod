...
class Index extends AccessKeys implements HttpGetActionInterface
{
    /**
     * Execute Render Page
     *
    ...
    public function execute(): Page
    {
        ...
        $resultPage->getConfig()->getTitle()->set(__('My Access Keys'));
        $resultPage->getConfig()->setDescription('Access Keys Table');
        return $resultPage;
    }
}
